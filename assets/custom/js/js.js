...
function postStyleDefault() {

    var posts = document.getElementsByClassName('post-style-default');
    var postStyle1 = document.getElementsByClassName('post-style-1');
    var postStyle2 = document.getElementsByClassName('post-style-2');
    for (var i = 0; i < posts.length; i++) {
        postStyle1[i].style.display = 'none';
        postStyle2[i].style.display = 'none';
...
function postStyle1() {
    ...
    for (var i = 0; i < posts.length; i++) {
        ...
        postStyle2[i].style.display = 'none';
        postStyle1[i].style.display = 'block';
    }
}
...
function postStyle2() {
    ...
    for (var i = 0; i < posts.length; i++) {
        posts[i].style.display = 'none';
        postStyle1[i].style.display = 'none';
        postStyle2[i].style.display = 'block';
    }
}
